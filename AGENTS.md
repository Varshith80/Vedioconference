# AGENTS.md — Vedioconference

> **Permanent instruction manual for every Codex session in this repository.**
...
## 4. Resume Workflow — what to do on every new Codex session
...
2. Read `C:\Users\Maniv\.Codex\projects\C--Vedioconference\memory\MEMORY.md` and the memory file(s) it indexes (long-lived facts about the user and the project).
...
## 11. AI Operating Rules (how Codex should behave on future sessions)
...
*Last updated: 2026-07-07. Owner: project lead. This file is the first thing every Codex session should read.*
